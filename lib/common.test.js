...
describe('Common API', function () {
  ...
  it('privateToPublic', function () {
    var pub = 'XMX859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM';
    assert.equal(ecc.privateToPublic(wif), pub);
  });

  it('isValidPublic', function () {
    var keys = [[true, 'XMX859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'], [false, 'MMM859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'], [false, 'XMX859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhTo']];
